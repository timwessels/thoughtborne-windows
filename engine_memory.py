...
carousel's fall-through, which is an outage rather than a choice. The tool
(`thoughtborne.py`, Ctrl+Alt+L) is the one writer: the settings app only READS
this file, to name the engine its remember-mode radio will start on (D-028).
