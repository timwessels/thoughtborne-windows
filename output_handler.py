...
class TranscriptionTask:
    ...
    error_inconclusive: bool = False  # Soniox-Live async file lane ran empty with >=1 errored stage, minus a conclusive auth reject -> "came back empty" on the FAILED panel (#159)
